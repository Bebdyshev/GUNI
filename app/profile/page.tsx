...
import { Award, BookOpen, CheckCircle2, Clock, Download, Edit } from "lucide-react"
...
export default function ProfilePage() {
  const userInfo = {
    name: "Алия Каримова",
    email: "aliya.karimova@example.com",
    credits: 250,
    joinDate: "15.01.2023",
    completedTests: 5,
    purchasedArticles: 3,
            ...
            <Card className="shadow-md rounded-2xl overflow-hidden border-none lg:col-span-1">
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      <CalendarIcon className="h-5 w-5 text-[#D14A68] mr-2" />
              ...
              <CardFooter className="flex justify-between">
                ...
                <Button
                  ...
                  className="border-[#D14A68] text-[#D14A68] hover:bg-[#D14A68] hover:text-white"
                >
                  <GearIcon className="h-4 w-4 mr-2" /> Настройки
                </Button>
              </CardFooter>
            </Card>
                    ...
                    >
                      <div className="flex items-center">
                        <div className="mr-3">
                          ...
                          {activity.type === "login" && <PersonIcon className="h-5 w-5 text-[#D14A68]" />}
                        </div>
                        <div>
